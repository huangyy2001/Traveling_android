...
public class ZurichActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv = (TextView) findViewById(R.id.zurichDesp);
        TextView ot = (TextView) findViewById(R.id.zurichOptText);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView tv = (TextView) ZurichActivity.this.findViewById(R.id.likeText);
                if (!isLike) {
