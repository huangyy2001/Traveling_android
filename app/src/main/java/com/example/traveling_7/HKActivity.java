...
public class HKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv = (TextView) findViewById(R.id.hkDesp);
        TextView ot = (TextView) findViewById(R.id.hkOptText);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextView tv = (TextView) HKActivity.this.findViewById(R.id.likeText);
                if (!isLike) {
